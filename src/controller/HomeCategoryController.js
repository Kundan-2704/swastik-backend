...
//         console.log("HOME CATEGORIES PAYLOAD 👉", req.body);
// console.log("SECTION ENUM 👉", Object.values(HomeCategorySection));
// console.log("PAYLOAD SECTION 👉", req.body.map(i => i.section));
